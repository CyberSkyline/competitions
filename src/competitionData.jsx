export default [
  ...
  },
  {
    header: 'CSAW RED',
    description: 'CSAW [see-SAH] is the most comprehensive student-run cyber security event in the world, featuring 10 hacking competitions, workshops, and industry events.',
    startDate: new Date('2020-09-18'),
    endDate: new Date('2020-09-27'),
    longDescription: (`
      The CSAW games, founded by Professor Nasir Memon as a small contest called Cyber Security Awareness Week, have grown to become the most comprehensive set of cybersecurity challenges by and for students around the globe.
      
      
      The Red Team Competition is designed for high-school students and occurs over two rounds, with an online Qualifying Round in September and in-person Final round in November. 
      
      The Qualification Round runs as a jeopardy-style CTF. Challenges are designed to encourage learning and skill-building in the areas of reversing, web security, forensics, crypto and pwning.
    `),
    logoURL: '/images/CSAW.jpg',
  ...
  },
  {
    ...
    longDescription: (`
      ...
      Are you ready for the challenge? Take the Cyber Quest challenge to compete for an invitation to one of the 2021 USCC Cyber Camps, which are scheduled throughout the summer around the country. 
    `),
  ...
  },
  {
    ...
    longDescription: (`
      The NeverLAN CTF is a jeopardy style Capture the Flag. This event was created with the goal of teaching the younger generation about Computer Science and the value of critical thinking and problem solving.
      ...
      To keep our event open to everyone, we split our scoreboard for student and non-student teams. For our event, student teams must consist of only student members, with a max of 4 members. Student members are users that are 14 years old or younger.
      
      To be notified when registration is up, visit our registration page.
    `),
  ...
  },
  {
    ...
    endDate: null,
    longDescription: (`
      CyberCenturion engages thousands of talented young individuals who are curious about cyber security and eager to put any existing cyber skills to the test. It mirrors the U.S. CyberPatriot competition, part of a global youth STEM education programme presented by the Northrop Grumman Foundation and created by the U.S. Air Force Association, aimed at inspiring youth to pursue careers in cyber security or other STEM disciplines critical to global security.
    `),
  ...
  },
  {
    ...
    longDescription: (`
      ...
      ångstromCTF is run by a team of students from Montgomery Blair High School. Now in our 6th year, we are one of the largest high school-oriented CTFs, with over 1700 competing teams in 2020. To see who helped out with each competition, check the individual competition sites.
      
      ångstromCTF is a great place to start if you've never done anything like this before! Our challenges are meant to guide students and help them develop their skills, even if they start off as a complete beginner. To get an idea for what the challenges will be like, be sure to try out the challenges from previous years.
